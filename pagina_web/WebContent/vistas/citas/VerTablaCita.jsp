			...
			<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="input-group mb-3">
								...
								<input type="text" id="cita" class="form-control" placeholder="# de cita"
									aria-label="Username" aria-describedby="basic-addon1"
									name="add_idcita" required="required">
							...
							<div class="input-group mb-3">
								...
								<input type="date" class="form-control" placeholder="Fecha consulta"
									aria-label="Username" aria-describedby="basic-addon1"
									name="add_fechaconsulta" required="required">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Nombre del medico"
									aria-label="Username" aria-describedby="basic-addon1"
									name="add_idmedico" required="required">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Nombre de usuario"
									aria-label="Username" aria-describedby="basic-addon1"
									name="add_idusuario" required="required">
						...
						<div class="modal-body">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="# de cita"
									...
									name="edit_idcita" required="required">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Nombre"
									...
									name="edit_idpaciente" required="required">
							...
							<div class="input-group mb-3">
								...
								<input type="date" class="form-control" placeholder="Fecha"
									...
									name="edit_fecha" required="required">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Especialidad"
									...
									name="edit_idespecialidad" required="required">
						...
						<div class="modal-body">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="# de cita"
									...
									name="del_idcita" required="required">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Nombre"
									...
									name="del_idpaciente" required="required">
