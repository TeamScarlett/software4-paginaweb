...
<%@page
	import="pkt_recetas.*, java.util.LinkedList,utils.Rutas"%>
	...
	<div class="container fluid" id="form_contenedor">
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							<a href="#añadirReceta" class="btn btn-success"
		...
		<table id="listado" class="table table-bordered table-hover table-dark">
				...
				<tbody>
					...
					LinkedList<Recetas> ListaRecetas = Tabla_recetas.getRecetas();

					for (int i = 0; i < ListaRecetas.size(); i++) {


						out.println("<tr scope=\"row\"></th>");
						out.println("<td id=\"idcitaedit\">" + ListaRecetas.get(i).getId() + "</td>");
						out.println("<td>" + ListaRecetas.get(i).getDescripcion()+ "</td>");
			...
			<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Formulario de Receta</h2>
		...
		<form action="ProcesarConsulta.jsp" name="sub_edit" method="post">
			<div class="modal" id="form-edit">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Editar Receta</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
