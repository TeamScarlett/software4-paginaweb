...
<%@page
	import="pkt_usuarios_especialidades.*, java.util.LinkedList,utils.Rutas"%>
...
<body>
	...
	<div class="container fluid" id="form_contenedor">
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							<a href="#añadirRegitro" class="btn btn-success"
		...
		<table id="listado" class="table table-bordered table-hover table-dark">
				...
				<tbody>
					...
					LinkedList<Usuarios_especialidades> ListaUsuarios_especialidades = Tabla_usuarios_especialidades.getUsuarios_especialidades();

					for (int i = 0; i < ListaUsuarios_especialidades.size(); i++) {


						out.println("<tr scope=\"row\"></th>");
						out.println("<td>" + ListaUsuarios_especialidades.get(i).getId() + "</td>");
						out.println("<td>" + ListaUsuarios_especialidades.get(i).getIdespecialidad()+ "</td>");
						out.println("<td>" + ListaUsuarios_especialidades.get(i).getIdusuario() + "</td>");
	...
	<%--############################################################################################################## --%>
<form action="ProcesarUsuarios_Esp.jsp" method="post" name="sub_add">
		<div class="modal" id="form-add">
			<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Formulario de Usuario Especialidad</h2>
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="ID especialidad"
									aria-label="Username" aria-describedby="basic-addon1"
									name="add_idespecialidad" required>
							</div>
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="ID especialidad"
									...
									name="edit_idespecialidad" required>
							</div>
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="ID especialidad"
									...
									name="del_idespecialidad" required>
							</div>
