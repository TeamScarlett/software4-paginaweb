<%@page
	import="pkt_laboratorios.*, java.util.LinkedList,utils.Rutas"%>
...
<title>Tabla Laboratorios</title>
</head>
...
<%--############################################################################################################## --%>
		<table id="listado" class="table table-bordered table-hover table-dark">
				...
				<tbody>
					...
					LinkedList<Laboratorios> ListaLaboratorios = Tabla_Laboratorios.getLaboratorios();
					...
					for (int i = 0; i < ListaLaboratorios.size(); i++) {
						...
						out.println("<td id=\"idedit\">" + ListaLaboratorios.get(i).getId() + "</td>");
						out.println("<td>" + ListaLaboratorios.get(i).getDescripcion() + "</td>");
			...
			<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Formulario de Laboratorio</h2>
	...
	<form action="ProcesarEstados.jsp" name="sub_edit" method="post">
		<div class="modal" id="form-edit">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h2 class="modal-title">Editar Laboratorio</h2>
						<button class="close" type="button" data-dismiss="modal">x</button>
					</div>
					<div class="modal-body">
		...
		<form action="ProcesarEstados.jsp" method="post" name="sub_del">
			<div class="modal" id="form-del">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Eliminar Laboratorio</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
