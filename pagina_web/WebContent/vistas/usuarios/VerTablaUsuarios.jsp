...
<%@page
	import="pkt_usuarios.*, java.util.LinkedList,utils.Rutas"%>
...
<body>
	...
	<div class="container fluid" id="form_contenedor">
		...
		<table id="listado" class="table table-bordered table-hover table-dark">
				...
				<tbody>
					...
					LinkedList<Usuarios> ListaUsuarios = Tabla_usuarios.getUsuarios();

					for (int i = 0; i < ListaUsuarios.size(); i++) {


						out.println("<tr scope=\"row\"></th>");
						out.println("<td>" + ListaUsuarios.get(i).getId() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getCedula() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getNombre() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getApellido() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getDireccion() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getEmail() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getPassword() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getCelular() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getIdtipousuario() + "</td>");
						out.println("<td>" + ListaUsuarios.get(i).getIdestado() + "</td>");
	...
	<%--############################################################################################################## --%>
<form action="ProcesarUsuarios.jsp" method="post" name="sub_add">
		<div class="modal" id="form-add">
			<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Formulario de usuario</h2>
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="# de cedula"
									aria-label="Username" aria-describedby="basic-addon1"
									name="add_cedula" required>
							</div>
...
<%--############################################################################################################## --%>		
		...
		<form action="ProcesarUsuarios.jsp" name="sub_edit" method="post">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="input-group mb-3">
								...
								<input type="text" readonly class="form-control" placeholder="# usuario"
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder=""
									id="data_edit8" aria-label="Username" aria-describedby="basic-addon1"
		...
		<form action="ProcesarUsuarios.jsp" method="post" name="sub_del">
					...
					<div class="modal-content">
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input type="text" readonly class="form-control" placeholder="# de cedula"
									id="data_del1" aria-label="Username" aria-describedby="basic-addon1"
									name="del_cedula" required>
							</div>
