<%@page
	import="pkt_consulta_sintomas.Tabla_Consulta_sintomas,pkt_consulta_sintomas.Consulta_sintomas, java.util.LinkedList,utils.Rutas"%>
	...
	<div class="container fluid" id="form_contenedor">
		...
		<table id="listado" class="table table-bordered table-hover table-dark">
				...
				<tbody>
					...
					LinkedList<Consulta_sintomas> ListaConsulta_sintomas = Tabla_Consulta_sintomas.getConsulta_sintomas();

					for (int i = 0; i < ListaConsulta_sintomas.size(); i++) {
			...
			<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Formulario de Consulta Sintomas</h2>
...
<%--############################################################################################################## --%>
	...
	<div class="container">
		...
		<form action="ProcesarConsultaSintomas.jsp" name="sub_edit" method="post">
			<div class="modal" id="form-edit">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Editar Consulta Sintomas</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
		...
		<form action="ProcesarConsultaSintomas.jsp" method="post" name="sub_del">
			<div class="modal" id="form-del">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Eliminar Consulta Sintomas</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
