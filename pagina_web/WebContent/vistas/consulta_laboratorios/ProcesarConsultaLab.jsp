...
if(add != null){
	...
	ModeloConsultaLab Modelo = new ModeloConsultaLab();
	if(Modelo.AgregarConsultaLab(add_id, add_idconsulta, add_idreceta, add_otro)){
...
if(del !=null){
	...
	ModeloConsultaLab Modelo = new ModeloConsultaLab();
	if(Modelo.EliminarConsultaLab(del_id)){
	response.sendRedirect("VerTablaConsultaLab.jsp");
	}
}
...
if(edit !=null){
	...
	ModeloConsultaLab Modelo = new ModeloConsultaLab();
	if(Modelo.ActualizarConsultaLab(edit_id, edit_idconsulta, edit_idreceta, edit_otro)){
	response.sendRedirect("VerTablaConsultaLab.jsp");
	}
}
