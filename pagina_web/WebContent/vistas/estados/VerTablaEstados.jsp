			...
			<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Formulario de estado</h2>
						...
						<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="# de entidad"
									aria-label="Username" aria-describedby="basic-addon1"
									name="add_entidad" required="required">
						</div>
	...
	<form action="ProcesarEstados.jsp" name="sub_edit" method="post">
		<div class="modal" id="form-edit">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h2 class="modal-title">Editar Estado</h2>
						<button class="close" type="button" data-dismiss="modal">x</button>
					</div>
					<div class="modal-body">
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" placeholder="# de Id"
								...
								aria-describedby="basic-addon1" name="edit_id"
								required="required">
						...
						<div class="input-group mb-3">
							...
							<input type="text" class="form-control" placeholder="Descripcion"
								...
								aria-describedby="basic-addon1" name="edit_descripcion"
								required="required">
						</div>
						...
						<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="# de entidad"
									...
									name="edit_entidad" required="required">
						</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="input-group mb-3">
								...
								<input type="text" readonly class="form-control" placeholder="# de Id"
