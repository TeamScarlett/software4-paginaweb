<%@page
	import="pkt_estados.*, java.util.LinkedList,utils.Rutas"%>
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							<a href="#añadirEstados" class="btn btn-success"
								data-toggle="modal" data-target="#form-estados"><i class="material-icons">&#xE147;</i> <span>Agregar</span></a>
...
<%--############################################################################################################## --%>
<form action="ProcesarEstados.jsp" method="post" name="sub_add">
		<div class="modal" id="form-estados">
						...
						<div class="input-group mb-3">
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Descripcion"
									aria-label="Username" aria-describedby="basic-addon1"
									name="estados_descripcion" required="required">
						</div>
							...
							<div class="input-group mb-3">
								...
								<input type="text" class="form-control" placeholder="Entidad"
									aria-label="Username" aria-describedby="basic-addon1"
									name="entidad" required="required">									
							</div>
...
<%--############################################################################################################## --%>
		<table id="listado" class="table table-bordered table-hover table-dark">
				...
				<tbody>
					...
					LinkedList<Estados> ListaEstados = Tabla_Estados.getEstados();
					...
					for (int i = 0; i < ListaEstados.size(); i++) {
						...
						out.println("<td id=\"idedit\">" + ListaEstados.get(i).getId() + "</td>");
						out.println("<td>" + ListaEstados.get(i).getDescripcion() + "</td>");
						out.println("<td>" + ListaEstados.get(i).getEntidad() + "</td>");
	...
	<div class="container">
		...
		<form action="ProcesarEstados.jsp" name="sub_edit" method="post">
			<div class="modal" id="form-edit">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Editar Estados</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
							...
							<div class="form-group">
								<label for="Id">Id</label> <input
									readonly class="form-control-plaintext" id="form_estados_id" type="text" required>
							</div>
							<div class="form-group">
								<label for="Descripcion">Descripcion</label> <input
									id="form_estados_descripcion" type="text" class="form-control" required>
							</div>

							<div class="form-group">
								<label for="Entidad">Entidad</label> <input
									id="form_estados_entidad" type="text" class="form-control" required>
							</div>
		...
		<form action="ProcesarEstados.jsp" method="post" name="sub_del">
			<div class="modal" id="form-del">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Eliminar estados</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
								...
								<div class="form-group">
								<label for="Id">Id</label> <input
									readonly class="form-control-plaintext" name="del_estados" id="del_estados" type="text" required>
							</div>
...
function selectRow(){
    ...
    for(var i=1;i<table.rows.length;i++){
        table.rows[i].onclick = function(){
          ...
          console.log(rindex);
          document.getElementById("form_estados_id").value = this.cells[0].innerHTML;
          document.getElementById("form_estados_descripcion").value = this.cells[1].innerHTML;
          document.getElementById("form_estados_entidad").value = this.cells[2].innerHTML;
      
          
          document.getElementById("del_estados").value = this.cells[0].innerHTML;
        };
    }
}
