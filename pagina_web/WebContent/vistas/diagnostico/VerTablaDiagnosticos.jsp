<%@page
	import="pkt_diagnosticos.Tabla_Diagnosticos,pkt_diagnosticos.Diagnosticos, java.util.LinkedList,utils.Rutas"%>
	...
	<div class="container fluid" id="form_contenedor">
		...
		<table id="listado" class="table table-bordered table-hover table-dark">
				...
				<tbody>
					...
					LinkedList<Diagnosticos> ListaDiagnosticos = Tabla_Diagnosticos.getDiagnosticos();
					...
					for (int i = 0; i < ListaDiagnosticos.size(); i++) {
						...
						out.println("<td id=\"idcitaedit\">" +ListaDiagnosticos.get(i).getId() + "</td>");
						out.println("<td>" + ListaDiagnosticos.get(i).getDescripcion() + "</td>");
			...
			<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Formulario de Diagnosticos</h2>
...
<%--############################################################################################################## --%>
		...
		<form action="ProcesarDiagnosticos.jsp" name="sub_edit" method="post">
			<div class="modal" id="form-edit">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Editar Diagnostico</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
		...
		<form action="ProcesarDiagnosticos.jsp" method="post" name="sub_del">
			<div class="modal" id="form-del">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h2 class="modal-title">Eliminar Diagnosticos</h2>
							<button class="close" type="button" data-dismiss="modal">x</button>
						</div>
						<div class="modal-body">
